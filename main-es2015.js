...
let DayBookComponent = class DayBookComponent {
    constructor(apiService, voucherService) {
    ...
    getCurrentVoucher() {
        this.apiService.getVouchers(new Date(), new Date()).subscribe(res => {
...
let AddressListViewComponent = class AddressListViewComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CustomerListViewComponent = class CustomerListViewComponent {
...
CustomerListViewComponent.ctorParameters = () => [
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let AgroInterceptor = class AgroInterceptor {
    constructor(cookie) {
        this.cookie = cookie;
    }
    ...
    intercept(request, next) {
        ...
        return next.handle(updatedRequest).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(event => {
...
AgroInterceptor.ctorParameters = () => [
...
let InvoicePrintViewComponent = class InvoicePrintViewComponent {
    constructor() {
        this.uniqueHSN = [];
        this.printing = false;
    }
...
ExpiredProductsComponent.ctorParameters = () => [
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let ProductListViewComponent = class ProductListViewComponent {
    constructor(apiService) {
        this.apiService = apiService;
        this.stockItems = [];
    }
    ...
    getAllStockItems() {
        this.apiService.getAllStockItems().subscribe(res => {
            var item;
            for (let item of res.stockItems) {
...
ProductListViewComponent.ctorParameters = () => [
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let UpdateCustomerComponent = class UpdateCustomerComponent {
    constructor(data, router, apiService) {
        this.data = data;
        this.router = router;
        this.apiService = apiService;
        if (data != null) {
...
let CashTenderedComponent = class CashTenderedComponent {
    constructor(messageInjected, dialogRef) {
...
CashTenderedComponent.ctorParameters = () => [
...
/* harmony import */ var _angular_material_button__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! @angular/material/button */ "./node_modules/@angular/material/esm2015/button.js");
...
/* harmony import */ var _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! @angular/material/autocomplete */ "./node_modules/@angular/material/esm2015/autocomplete.js");
/* harmony import */ var _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! @angular/material/datepicker */ "./node_modules/@angular/material/esm2015/datepicker.js");
...
/* harmony import */ var _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! @angular/material/toolbar */ "./node_modules/@angular/material/esm2015/toolbar.js");
...
/* harmony import */ var ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ngx-webstorage-service */ "./node_modules/ngx-webstorage-service/fesm2015/ngx-webstorage-service.js");
...
let CreateAddressFormComponent = class CreateAddressFormComponent {
    constructor(data, router, apiService) {
        this.data = data;
        this.router = router;
        this.apiService = apiService;
    ...
    ngOnInit() {
        this.apiService.getPlaceOfSupplies().subscribe(res => {
    ...
    submit() {
        this.apiService.addAddress(this.address).subscribe(res => {
            console.log("Address Created");
        }, err => {
            alert("Could not complete request. Please try again later");
        });
    }
    fillCustomer(address) {
        this.address = address;
    }
};
CreateAddressFormComponent.ctorParameters = () => [
...
let CreateComplaintFormComponent = class CreateComplaintFormComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CreateCustomerFormComponent = class CreateCustomerFormComponent {
    constructor(data, router, apiService) {
        this.data = data;
        this.router = router;
        this.apiService = apiService;
    ...
    submit() {
        this.apiService.addCustomer(this.customer).subscribe(res => {
            alert(res);
        }, err => {
...
CreateCustomerFormComponent.ctorParameters = () => [
...
let CreateOrderFormComponent = class CreateOrderFormComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CreateStockItemFormComponent = class CreateStockItemFormComponent {
    constructor(data, router, apiService) {
        this.data = data;
        this.router = router;
        this.apiService = apiService;
    ...
    ngOnInit() {
        this.apiService.getGodownNames().subscribe(res => {
            this.godowns = res.list;
        }, err => {
            console.log(err);
        });
        this.apiService.getSalesLedger().subscribe(res => {
    ...
    submit() {
        this.apiService.saveStockItem(this.item).subscribe(res => { console.log("stockItem saved"); }, err => { console.log("stockItem could not be saved"); });
    }
    addPriceListItem() {
...
CreateStockItemFormComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_4__["MAT_DIALOG_DATA"],] }] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_shared_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"],] }] }
];
...
let CreateTaxDetailsFormComponent = class CreateTaxDetailsFormComponent {
    constructor(data, router, apiService) {
        this.data = data;
        this.router = router;
        this.apiService = apiService;
    ...
    submit() {
        this.apiService.addTaxDetail(this.taxDetail).subscribe(res => {
            console.log(res);
        }, err => {
...
CreateTaxDetailsFormComponent.ctorParameters = () => [
...
let CreateUserFormComponent = class CreateUserFormComponent {
    ...
    ngOnInit() {
        this.apiService.getCashLedgers().subscribe(res => {
            console.log(res);
        ...
        this.apiService.getVoucherTypeName().subscribe(res => {
    ...
    submit() {
        this.apiService.saveUser(this.user).subscribe(res => {
            console.log(res);
        }, err => {
            console.log(err);
        });
...
CreateUserFormComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_shared_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"],] }] }
];
...
let CreateVoucherComponent = class CreateVoucherComponent {
    constructor(voucherService, apiService, dialog, dialogConfig, cookie, posService) {
        this.voucherService = voucherService;
        this.apiService = apiService;
        this.dialog = dialog;
    ...
    ngOnInit() {
        ...
        this.apiService.getCustomers().subscribe(res => {
            ...
            this.filteredOptions = this.myControl.valueChanges
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(value => typeof value === 'string' ? value : value.name), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(name => name ? this._filter(name) : this.customers.slice()));
        }, err => {
            console.log("Cannot fetch customer at this moment");
        });
        this.apiService.getAllStockItemsForBilling().subscribe(res => {
            this.products = res;
            if (this.editMode) {
                var p;
                for (let item of this.tallyVoucher.billedStockItems) {
            ...
            this.productFilteredOptions = this.invControl.valueChanges
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(value => typeof value === 'string' ? value : value.name), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(name => name ? this.product_filter(name) : this.products.slice()));
        }, err => {
    ...
    displayCustomerHistory() {
        this.apiService.getCustomerHistory(this.myControl.value._id).subscribe(res => {
    ...
    saveVoucher() {
        ...
        const dialogRef = this.dialog.open(_VoucherPackage_cash_tendered_cash_tendered_component__WEBPACK_IMPORTED_MODULE_11__["CashTenderedComponent"], {
            width: '350px',
        ...
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                ...
                this.apiService.saveTallyVoucher(this.tallyVoucher).subscribe(res => {
    ...
    setTallyVoucher(tallyVoucher) {
        this.tallyVoucher = tallyVoucher;
    }
};
CreateVoucherComponent.ctorParameters = () => [
...
let LoginFormComponent = class LoginFormComponent {
    constructor(apiService, router, cookie) {
        this.apiService = apiService;
        this.router = router;
        this.cookie = cookie;
        this.user = {
    ...
    validate() {
        ...
        this.apiService.authenticate(this.user).subscribe(res => {
...
let AgroStorageService = class AgroStorageService {
    ...
    storeVoucherLocally(tallyVoucher) {
...
AgroStorageService.ctorParameters = () => [
...
let PosService = class PosService {
    ...
    addCacheVoucher(voucher) {
        return this.db.add('cacheVoucher', voucher);
    }
    countCacheVoucher() {
        this.db.count('cacheVoucher').then(voucherCount => {
            return voucherCount;
        }, error => {
            console.log(error);
        });
    ...
    syncAllCacheVouchers() {
        this.db.getAll('cacheVoucher').then(vouchers => {
            for (let voucher of vouchers) {
                this.apiService.saveTallyVoucher(voucher).subscribe(res => {
...
let SideNavigationBarComponent = class SideNavigationBarComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let StockItemsComponent = class StockItemsComponent {
    constructor(apiService) {
        this.apiService = apiService;
        this.items = [
...
StockItemsComponent.ctorParameters = () => [
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
...
let AddressTableComponent = class AddressTableComponent {
    constructor(apiService, dialog, dialogConfig) {
        this.apiService = apiService;
        this.dialog = dialog;
        this.dialogConfig = dialogConfig;
        this.addresses = [];
    ...
    ngOnInit() {
        this.apiService.getAllAddresses().subscribe(res => {
            this.addresses = res;
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.addresses);
    ...
    updateAddress(data) {
        ...
        dialogConfig.autoFocus = true;
        dialogConfig.width = "50%";
        this.dialog.open(_create_form_create_address_form_create_address_form_component__WEBPACK_IMPORTED_MODULE_7__["CreateAddressFormComponent"], { data });
    }
    createCustomer() {
        const dialogConfig = new _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogConfig"]();
        dialogConfig.autoFocus = true;
...
AddressTableComponent.ctorParameters = () => [
...
let BatchTableComponent = class BatchTableComponent {
    constructor(apiService, dialog, dialogConfig) {
        this.apiService = apiService;
        this.dialog = dialog;
        this.dialogConfig = dialogConfig;
    ...
    getBatches(daysRemaining) {
        this.apiService.getNearExpiryBatches(daysRemaining).subscribe(res => {
            this.batches = res;
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.batches);
            this.dataSource.sort = this.sort;
            this.dataSource.paginator = this.paginator;
...
BatchTableComponent.ctorParameters = () => [
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogConfig"] }
];
...
let CustomerTableComponent = class CustomerTableComponent {
    ...
    updateCustomer(data) {
        ...
        dialogConfig.autoFocus = true;
        dialogConfig.width = "50%";
        this.dialog.open(_create_form_create_customer_form_create_customer_form_component__WEBPACK_IMPORTED_MODULE_7__["CreateCustomerFormComponent"], { data });
    }
    deleteCustomer(data) {
        const dialogRef = this.dialog.open(_confirmation_box_confirmation_box_component__WEBPACK_IMPORTED_MODULE_8__["ConfirmationBoxComponent"], {
            width: '350px',
            data: "Do you confirm the deletion of this customer: " + data.name + " ?"
        });
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                this.apiService.deleteCustomer(data).subscribe(res => {
...
CustomerTableComponent.ctorParameters = () => [
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogConfig"] }
];
...
let StockItemTableComponent = class StockItemTableComponent {
    constructor(apiService, dialog, dialogConfig) {
        this.apiService = apiService;
        this.dialog = dialog;
        this.dialogConfig = dialogConfig;
    ...
    updateStockItem(data) {
        ...
        dialogConfig.autoFocus = true;
        dialogConfig.width = "50%";
        this.dialog.open(_create_form_create_stock_item_form_create_stock_item_form_component__WEBPACK_IMPORTED_MODULE_7__["CreateStockItemFormComponent"], { data });
    }
};
StockItemTableComponent.ctorParameters = () => [
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogConfig"] }
];
...
let TaxDetailsTableComponent = class TaxDetailsTableComponent {
    constructor(apiService, dialog, dialogConfig) {
        this.apiService = apiService;
        this.dialog = dialog;
        this.dialogConfig = dialogConfig;
    ...
    ngOnInit() {
        this.apiService.getTaxDetails().subscribe(res => {
            this.taxDetails = res;
    ...
    updateTaxDetail(data) {
        ...
        dialogConfig.autoFocus = true;
        dialogConfig.width = "50%";
        this.dialog.open(_create_form_create_tax_details_form_create_tax_details_form_component__WEBPACK_IMPORTED_MODULE_8__["CreateTaxDetailsFormComponent"], { data });
    }
    deleteTaxDetail(data) {
        const dialogRef = this.dialog.open(_confirmation_box_confirmation_box_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmationBoxComponent"], {
            width: '350px',
            data: "Do you confirm the deletion of this customer: " + data.name + " ?"
        });
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                this.apiService.deleteTaxDetails(data).subscribe(res => {
                    alert("Customer deleted successfully");
                }, err => {
                    console.log(err);
                });
...
TaxDetailsTableComponent.ctorParameters = () => [
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogConfig"] }
];
...
let VoucherTableComponent = class VoucherTableComponent {
    constructor(apiService, dialog, dialogConfig, voucherService, router) {
        this.apiService = apiService;
        this.dialog = dialog;
        this.dialogConfig = dialogConfig;
        this.voucherService = voucherService;
...
VoucherTableComponent.ctorParameters = () => [
    { type: _shared_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogConfig"] },
...
let ComplaintViewComponent = class ComplaintViewComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CustomerViewComponent = class CustomerViewComponent {
    constructor(customerInjected) {
...
CustomerViewComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
];
...
let StockItemViewComponent = class StockItemViewComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let VoucherViewComponent = class VoucherViewComponent {
    constructor() { }
    ngOnInit() {
    }
};
